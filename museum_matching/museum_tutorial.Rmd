---
title:  "Matching survey data with cataloged specimens"
output:
...
We can look at the attributes of the lakes for which there are cataloged specimens, including lake surface area (ha), maximum depth (m), and surface temperature (degC) during the survey from the summary card data.
...
Finally, we can map the lakes with survey data and associated cataloged specimens.
